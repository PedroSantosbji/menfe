...
function PageOverview() {
  ...
  const PHASES = [
    {
      ...
      entregaveis: [
        ...
        "Design System + Protótipo App do Investidor",
      ],
      funcionalidades: [
        "Autenticação e permissões",
        "Gestão financeira do investidor",
        "Listagem de empreendimentos",
        "Patrimônio e evolução de obra",
        "Contratos",
        "Notificações push",
        "Log de atividades",
    ...
    },
    {
      ...
      title: "App do Hóspede · Collegiate",
      icon: "🏠",
      objetivo: "Expandir a plataforma para o segundo perfil de usuário: o hóspede do Collegiate. Criar a experiência digital de quem ocupa o imóvel — financeiro, serviços, reservas e carrinho.",
      publico: "Hóspedes ativos dos empreendimentos Collegiate.",
      entregaveis: [
        "App Collegiate — área logada (React Native · iOS & Android)",
        "Expansão App Menfe F2 (mapas, gestão de investimentos, carrinho)",
        "Backoffice F2 (hóspedes, quartos, serviços e reservas)",
        "Backend F2 (sistema de venda, carrinho, booking e financeiro de hóspedes)",
        "Design System + Protótipo App Collegiate",
      ],
      funcionalidades: [
        "App Collegiate: autenticação e perfil do hóspede",
        "Lista de quartos e serviços",
        "Carrinho e gestão de reservas",
        "Financeiro: pagamentos e histórico",
        "Avisos e notificações",
        "App Menfe: mapas e gestão de investimentos",
        "App Menfe: carrinho",
    ...
    },
    {
      ...
      title: "App Collegiate · Gestão Avançada",
      icon: "🏗️",
      objetivo: "Completar a experiência do hóspede com funcionalidades avançadas: chat integrado, gestão de quartos, reserva de áreas comuns, mapas e agendamento de serviços. Esta fase consolida o Collegiate como uma plataforma de moradia — próxima ao modelo Airbnb/Quinto Andar.",
      publico: "Hóspedes ativos e equipe de gestão do Collegiate.",
      entregaveis: [
        "App Collegiate F3 — novas funcionalidades sobre a base F2",
        "Backoffice F3 (gestão de áreas comuns)",
        "Backend F3 (gestão de quartos e reservas de áreas comuns)",
        "Design System + Protótipo App Collegiate F3",
      ],
      funcionalidades: [
        "Chat integrado no app (M9)",
        "Gestão de quartos (M9–M10)",
        "Reserva de áreas comuns (M10)",
        "Mapas do empreendimento (M11)",
        "Agendamento de serviços (M12)",
  ...
  const SISTEMAS = [
    ...
    { abbr:"F1",  nome:"App Menfe · React Native",       color:"#1A2445", fases:"F1→F2", desc:"App do investidor. Portfólio, obras, financeiro, contratos, lançamentos e notificações." },
...
function PageArchitecture({ phase = "F1" }) {
  ...
  const SYSTEMS = {
    ...
    menfe: {
      ...
      desc: "App do investidor Menfe — MVP da plataforma. Login, portfólio de imóveis, evolução de obras em tempo real, contratos PDF, histórico financeiro, hall de lançamentos com botão 'Quero Investir' redirecionando a WhatsApp e notificações push.",
      screens: [
        { p: "Autenticação & Home", items: ["Login com CPF/e-mail + senha + biometria", "Home com patrimônio total e variação %", "Ações rápidas: portfólio, financeiro, notificações", "Atividade recente e avisos de vencimento"] },
        ...
        { p: "Perfil & Notificações", items: ["Notificações segmentadas por tipo", "Perfil, segurança e configurações", "Ajuda e suporte"] },
      ],
    },
    collegiate: {
    ...
    collegiate_f3: {
      ...
      desc: "Expansão do App Collegiate entregue na Fase 2. A Fase 3 adiciona funcionalidades avançadas: chat integrado, gestão de quartos, reserva de áreas comuns, mapas do empreendimento e agendamento de serviços.",
      screens: [
        ...
        { p: "✦ Novo · Áreas Comuns & Mapas", items: ["Reserva de áreas comuns (piscina, churrasqueira, salão)", "Calendário de disponibilidade e histórico de reservas", "Mapa interativo do empreendimento", "Agendamento de serviços (limpeza, manutenção)"] },
      ],
    },
  };
